...
const OverallCatchedFish = () => {
          ...
          const fetchDataFromAPI = async () => {
                    try {
                              const response = await fetch('http://localhost:5000/api/v1/dataentrys/locWiseTotal'); // Replace with your API endpoint
                              if (!response.ok) {
...
export default OverallCatchedFish;